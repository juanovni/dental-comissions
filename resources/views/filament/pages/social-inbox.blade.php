                ...
                <div class="smart-drawer-body">
                    @if ($selectedComment->conversion_status === \App\Enums\SocialConversionStatus::PendingPatientCreation)
                        <div class="smart-action-banner" style="margin-bottom:.75rem">
                            ...
                            <a class="smart-action-link" href="{{ \App\Filament\Resources\SocialComments\SocialCommentResource::getUrl('view', ['record' => $selectedComment], panel: 'clinic', tenant: $selectedComment->clinic ?? \Filament\Facades\Filament::getTenant() ?? \App\Models\Clinic::query()->orderBy('id')->first()) }}">Crear ficha</a>
                        </div>
                    @endif
