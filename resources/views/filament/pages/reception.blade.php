<x-filament-panels::page>
    ...
    <style>
        ...
        .reception-toolbar { align-items: center; display: flex; gap: .75rem; justify-content: flex-end; margin-bottom: .9rem; margin-top: -4.05rem; }
        .reception-search { background: #fff; border: 1px solid #e5e7eb; border-radius: .5rem; box-shadow: none; color: #0f172a; font-size: .82rem; height: 2.35rem; outline: none; padding: .45rem .75rem; width: min(100%, 24rem); }
        ...
        .reception-alerts-heading { color: #0f172a; font-size: .92rem; font-weight: 600; }
        ...
        .reception-alerts-badge { border-radius: 999px; display: inline-flex; font-size: .72rem; font-weight: 600; padding: .3rem .6rem; }
        ...
        .reception-alert-card-critical { background: #fff; border-color: #dc2626; color: #111827; }
        .reception-alert-card-warning { background: #fff; border-color: #ca8a04; color: #111827; }
        ...
        .reception-alert-name { display: block; font-size: .9rem; font-weight: 600; line-height: 1.25; }
        .reception-alert-meta { color: #cbd5e1; display: block; font-size: .78rem; margin-top: .35rem; }
        .reception-alert-card-critical .reception-alert-meta, .reception-alert-card-critical .reception-alert-column, .reception-alert-card-warning .reception-alert-meta, .reception-alert-card-warning .reception-alert-column, .reception-alert-card-neutral .reception-alert-meta, .reception-alert-card-neutral .reception-alert-column { color: #64748b; }
        ...
        .reception-alert-time { align-items: center; border-radius: 999px; display: inline-flex; font-size: .78rem; font-weight: 600; gap: .3rem; padding: .28rem .55rem; }
        ...
        .reception-action-primary { background: oklch(55% .12 185); border-color: oklch(55% .12 185); color: #ffffff; }
        .reception-action-primary:hover { background: oklch(50% .12 185); border-color: oklch(50% .12 185); color: #ffffff; }
        ...
        .dark .reception-action-primary { background: oklch(55% .12 185); border-color: oklch(55% .12 185); color: #ffffff; }
        .dark .reception-action-primary:hover { background: oklch(50% .12 185); border-color: oklch(50% .12 185); color: #ffffff; }
    ...
    <div class="reception-page" wire:poll.visible.10s>
        ...
        <div class="reception-kpis">
            ...
            <div class="reception-kpi"><span class="reception-kpi-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-triangle-alert size-4" aria-hidden="true"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"></path><path d="M12 9v4"></path><path d="M12 17h.01"></path></svg></span><div><div class="reception-kpi-label">Retrasados</div><div class="reception-kpi-value">{{ $summary['overdue'] }}</div></div></div>
