...
use App\Filament\Pages\SocialLeadAlerts;
...
class SocialLeadAlertsTest extends TestCase
{
    use RefreshDatabase;

    public function test_alerts_page_lists_and_resolves_alert(): void
    {
        ...
        $alert = SocialLeadAlert::create([
            ...
            'severity' => 'danger',
            'title' => 'Lead caliente',
            'message' => 'Requiere atencion.',
        ]);

        Livewire::actingAs(User::factory()->create())
            ->test(SocialLeadAlerts::class)
